...
Usage:
    ros2 launch gazebo_spawn m1_localization_sim.launch.py
...
def generate_launch_description():
    ...
    sim_gps_fix = Node(
        ...
        parameters=[{
            ...
            'datum_alt': 100.0,
            # base_footprint is now at the rear axle; front GPS (gps_link) is
            # wheelbase/2 + 0.35 + (wheel_radius offset) = 1.35m ahead.
            'antenna_x': 1.35,
            'antenna_y': 0.0,
            'rate_hz': 10.0,
        }],
