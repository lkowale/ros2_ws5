...
pkill -f "plant_row_detector_sim\|tool_slider_controller\|tool_actuator_sim\|field_nav_logger.py" 2>/dev/null || true
sleep 2

LOG_DIR="$HOME/ros2_ws5/logs/m4_field_sim"
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/m4_field_sim_$(date +%Y%m%d_%H%M%S).log"
